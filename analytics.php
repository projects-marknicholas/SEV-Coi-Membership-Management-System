    ...
    <div class="grid-3">
                ...
                <?php
                    ...
                    if (mysqli_num_rows($sres) > 0) {
                        while ($row = mysqli_fetch_assoc($sres)) {
                            ...
                            $direct = dirname("repositories/".$name."/".$result['repository_name']."/".$file_name);
        ...
        <?php
            ...
            if (strpos($url, "index.html") === false) {
                $url = "http://www.statichost.rf.gd/repositories/".$name."/".$repository."/index.html";
            }
            else{
                $url = "http://www.statichost.rf.gd/repositories/".$name."/".$repository."/";
            }
